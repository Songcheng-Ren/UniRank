...
class QFormerCross3(QFormerCross2):
    """SDPA/Flash-Attention variant of the two-stage QFormerCross2.
    ...
    * CrossValue uses standard head-local Q/K/V layouts, performs SDPA first,
    ...
    def __init__(self, feature_map, model_id="QFormerCross3", **kwargs):
        super().__init__(
            feature_map,
            model_id=model_id,
